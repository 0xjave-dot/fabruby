...
const fallbackShareImage = "https://i.ibb.co/G4BYJN9h/Gemini-Generated-Image-j1yadkj1yadkj1ya-removebg-preview.png";
...
function buildMetaTags(req: express.Request, productId?: string) {
  ...
  const title = product ? `${product.name} | Fabruby` : "Fabruby";
  const description = product
    ? product.description
    : "Fabruby fashion storefront with curated products, checkout, and shareable product previews.";
  ...
  return `
    ...
    <meta property="og:image:alt" content="${escapeHtml(product?.name ?? "Fabruby")}" />
