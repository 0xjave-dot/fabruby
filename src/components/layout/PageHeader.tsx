...
export function PageHeader({ title, left, right }: PageHeaderProps) {
  return (
    <div className="sticky top-0 z-[70] flex-none flex items-center justify-between px-4 sm:px-5 py-3 bg-white/92 backdrop-blur-xl border-b border-black/5 shadow-[0_4px_18px_rgba(0,0,0,0.04)]">
