...
export default function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col bg-white animate-fade-up-enter pb-10">
      {/* Top Header Section */}
      <div className="flex md:hidden items-center gap-2.5 px-4 sm:px-5 py-2.5 sticky top-0 bg-white/90 backdrop-blur-xl z-[70] border-b border-[#e5e5e5] shadow-[0_4px_18px_rgba(0,0,0,0.04)]">
